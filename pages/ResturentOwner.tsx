...
function ResturentOwner() {
    ...
    const getFoodCart = () => {
        onSnapshot(
            ...
            query(collection(db, "foodcart")), (snapshot) => {
                    ...
                    <div className='container'>
                        <div className={`${DCss.rows} ${DCss.dash_head_row}`}>
                            ...
                            <div className={`${DCss.dash_head_width}`}>
                                <Link href="/AddResturent"><li><a><i className='fas fa-utensils'></i> Add Restaurants</a></li></Link>
                                <Link href="/AddFoodCart"><li><a><i className='fas fa-utensils'></i>Add Food Cart</a></li></Link>
                        ...
                        <div className={`${DCss.rows}`}>
                            ...
                            <div className={`${DCss.left_reviews}`}>
                                <h3 className={`${DCss.left_reviews_head_fir}`}>Total views</h3>
                                <div className={`${DCss.progress_reviews}`}>
                                    <span className={`${DCss.review_head_sec}`}>Total Views Today</span>
                                    <div className={`${DCss.progress}`}>
                                        <span className={`${DCss.title} ${DCss.timer}`} data-from="0" data-to="85" data-speed="1800">85</span>
                                ...
                                <div className={`${DCss.bottom_rviews}`}>
                                    <span className={`${DCss.last_day_re}`}>
                                        ...
                                        <div className={`${DCss.inner_divs}`}>
                                            <i className="fas fa-long-arrow-alt-up" id={`${DCss.green}`}></i>
                                            <small>5555</small>
                                        </div>
                                    </span>
                                    <span className={`${DCss.last_week_re}`}>
                                        Last Week
                                        <div className={`${DCss.inner_divs}`}>
                                            <i className="fas fa-long-arrow-alt-down" id={`${DCss.red}`}></i>
                                            <small>5555</small>
                                        </div>
                                    </span>
                        ...
                        <div className={`${DCss.mr_top} ${DCss.rows}`}>
                            ...
                            <div className={`${DCss.top_five_cards}`}>
                                <h3 className={`${DCss.left_reviews_head_fir}`}>Top 5 Food Carts</h3>
        ...
        <div className={`${DCss.top_cards_item}`}>
            ...
            <h3 className={`${DCss.top_cards_title}`}>The Taco Cartel
                ...
                <span className={`${DCss.top_cards_ddes}`}>Los Angeles, CA, USA</span>
                            ...
                            <div className={`${DCss.top_five_cards}`}>
                                <h3 className={`${DCss.left_reviews_head_fir}`}>Top 5 Restaurants</h3>
                ...
                <span className={`${DCss.top_cards_ddes}`}>Los Angeles, CA, USA</span>
                        ...
                        <div className={`${DCss.mr_top} ${DCss.rows}`}>
                            <div className={`${DCss.customer_reviews_section}`}>
                                <h3 className={`${DCss.left_reviews_head_fir}`}>Customer Reviews (580)</h3>

                                <div className={`${DCss.top_scrolling}`}>
                                    <div className={`${DCss.dash_review}`}>
                                        <div className={`${DCss.top_cards_item} ${DCss.customer_cards}`}>
                                            <Image src="/img/test.png" alt="" width={500} height={500} />
                                            <h3 className={`${DCss.top_cards_title}`}>The Taco Cartel
                                                <br />
                                                <span className={`${DCss.top_cards_ddes}`}>Los Angeles, CA, USA</span>
                                        ...
                                        <div className={`${DCss.dast_re_text}`}>
                                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.
                                                Repellendus, suscipit, ea ipsam corrupti quibusdam consequuntur sint tempora iusto unde quos,
                                                ad animi tempore beatae quia dolore inventore deserunt! Dignissimos, culpa.
                                            </p>
                                        </div>
                                    </div>
                                    <div className={`${DCss.dash_review}`}>
